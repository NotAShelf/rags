...
- `control`:
  [Gvc.MixerControl](https://gjs-docs.gnome.org/gvc10~1.0/gvc.mixercontrol)
...
- `stream`
  [Gvc.MixerStream](https://gjs-docs.gnome.org/gvc10~1.0/gvc.mixerstream) the
...
- `icon-name`: `string`
- `id`: `number`
- `is-muted`: `boolean` this returns if volume is 0, setting this to true sets
