...
You will see nothing happen, just RAGS hanging,
...
RAGS has builtin [Services](../configuration/06-services.md).
They are just like [Variables](../configuration/03-variables.md) but instead
