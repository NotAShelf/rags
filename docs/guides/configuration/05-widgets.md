...
`Widget` functions return an instance of
[Gtk.Widget](https://gjs-docs.gnome.org/gtk30~3.0/gtk.widget). Most common
widgets are subclassed and have a few additional properties.

These widgets have some additional properties on top of the base Gtk.Widget
ones:
...
for attaching additional attributes on widgets `Object.assign` or the
`attribute` property can be used
...
using `attribute` has the benefit of it being a gobject which means it will
signal `notify::attribute` when it changes
...
keep in mind that `attribute` will only signal if _its value_ changes
...
If you don't want to mutate the `classNames` array, there is `toggleClassName`:
...
base Gtk.Widget classes.
[Refer to the Gtk3 docs](https://gjs-docs.gnome.org/gtk30~3.0/) for the rest of
them.
...
subclass of
[Gtk.ColorButton](https://gjs-docs.gnome.org/gtk30~3.0/gtk.colorbutton)
...
subclass of
[Gtk.DrawingArea](https://gjs-docs.gnome.org/gtk30~3.0/gtk.drawingarea)
...
subclass of
[Gtk.FileChooserButton](https://gjs-docs.gnome.org/gtk30~3.0/gtk.filechooserbutton)
...
> [!NOTE]
> `Gtk.Fixed` is not yet subclassed to be declarative and doesn't have any
> additional properties/methods on top of the base Gtk widget.
...
> [!NOTE]
> `Gtk.FlowBox` is not yet subclassed to be declarative and doesn't have any
> additional properties/methods on top of the base Gtk widget.
...
subclass of
[Gtk.FontButton](https://gjs-docs.gnome.org/gtk30~3.0/gtk.fontbutton)
...
> [!NOTE]
> `Gtk.ListBox` is not yet subclassed to be declarative and doesn't have any
> additional properties/methods on top of the base Gtk widget.
...
> [!NOTE]
> `Gtk.MenuBar` is not yet subclassed to be declarative and doesn't have any
> additional properties/methods on top of the base Gtk widget.
...
subclass of
[Gtk.ProgressBar](https://gjs-docs.gnome.org/gtk30~3.0/gtk.progressbar)
...
subclass of
[Gtk.ScrolledWindow](https://gjs-docs.gnome.org/gtk30~3.0/gtk.scrolledwindow)
...
subclass of
[Gtk.SpinButton](https://gjs-docs.gnome.org/gtk30~3.0/gtk.spinbutton)
...
subclass of
[Gtk.ToggleButton](https://gjs-docs.gnome.org/gtk30~3.0/gtk.togglebutton)
