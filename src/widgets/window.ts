...
/** GTK Window wrapper configured as a Wayland layer shell surface. */
...
export class Window<Child extends Gtk.Widget, Attr> extends Gtk.Window {
    ...
    /** @deprecated Use `exclusivity` instead. */
    get exclusive() {
    ...
    /** @deprecated Popup behavior relied on a compositor bug. Use keybinds instead. */
    get popup() {
    ...
    /** @deprecated Use `keymode` instead. */
    get focusable() {
