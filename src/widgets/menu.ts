...
/** Event handlers for Menu popup and scroll events. */
...
/** GTK Menu wrapper for displaying a popup menu with menu items. */
...
export class Menu<MenuItem extends Gtk.MenuItem, Attr> extends Gtk.Menu {
    ...
    /** The menu item children of this menu. */
    get children() {
